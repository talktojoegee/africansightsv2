    ...
    */
    ...
    public function showResetForm($token)
    {
        ...
        if(!empty($request)){
            ...
            session()->flash("error", "Password reset link has expired or is no longer valid.");
    ...
    public function reset(Request $request)
    {
        ...
        if(!empty($token)){
            ...
            session()->flash("success", "You've successfully reset your password. Proceed to login.");
